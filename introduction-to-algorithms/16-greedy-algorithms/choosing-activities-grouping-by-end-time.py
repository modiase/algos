...
def optimal_group_activities(activities: Collection[Activity]) -> List[List[Activity]]:
    ...
    for activity in sorted_activities:
        ...
        for group in groups:
            ...
            if not any(activity.overlaps_with(group_activity) for group_activity in group):
...
if __name__ == "__main__":
    ...
    test_cases = [
        ...
        [Activity(1, 3), Activity(2, 4), Activity(6, 8), Activity(7, 9), Activity(11, 13)], # Multiple non-overlapping groups
        [Activity(1, 10), Activity(2, 9), Activity(3, 8), Activity(4, 7)], # Nested intervals
    ]
