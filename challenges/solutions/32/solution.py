...
def detect_arbitrage(conversion_rates: ConversionRates, 
                     start_currency: str) -> Optional[Tuple[str,...]]:
...
class Arguments:
    ...
    def parse_args(cls):
        ...
        parser.add_argument('currencies_file', help='The file containing exchange '
