...
import (
	bitpkg "algos/data-structures/trees/binary-indexed-tree/pkg"
	"testing"
)

var intSumGroup = bitpkg.NewGroup[int](
...
func TestNew(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			bit := bitpkg.NewGeneric[int](tt.size, intSumGroup)
			if bit.Size() != tt.want {
...
func TestNewPanicsOnInvalidSize(t *testing.T) {
	...
	for _, size := range tests {
		t.Run("invalid size", func(t *testing.T) {
			...
			bitpkg.NewGeneric[int](size, intSumGroup)
		})
	}
}
...
func TestNewFromArray(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			bit := bitpkg.NewFromArrayGeneric[int](tt.arr, intSumGroup)
...
func TestUpdate(t *testing.T) {
	t.Run("single update", func(t *testing.T) {
		bit := bitpkg.NewGeneric[int](5, intSumGroup)
		bit.Update(3, 10)
	...
	t.Run("multiple updates different indices", func(t *testing.T) {
		bit := bitpkg.NewGeneric[int](6, intSumGroup)
		updates := []struct {
			index int
			delta int
		}{
	...
	t.Run("negative updates", func(t *testing.T) {
		bit := bitpkg.NewFromArrayGeneric[int]([]int{10, 20, 30, 40, 50}, intSumGroup)
...
func TestPrefixSum(t *testing.T) {
	...
	bit := bitpkg.NewFromArrayGeneric[int](arr, intSumGroup)
...
func TestPrefixSumAfterUpdates(t *testing.T) {
	bit := bitpkg.NewFromArrayGeneric[int]([]int{1, 2, 3, 4, 5}, intSumGroup)
...
func TestBITOperationsIntegration(t *testing.T) {
	bit := bitpkg.NewGeneric[int](10, intSumGroup)
