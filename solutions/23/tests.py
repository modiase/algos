...
class TestCase(unittest.TestCase):
    ...
    def test_tile_is_not_wall(self):
        self.assertTrue(tile_is_not_wall(tile=(0,0), matrix=self.basic_matrix))
        self.assertTrue(tile_is_not_wall(tile=(1,2), matrix=self.given_matrix))
        
    def test_tile_is_wall(self):
        self.assertFalse(tile_is_not_wall(tile=(1,0), matrix=self.given_matrix))
        self.assertFalse(tile_is_not_wall(tile=(1,3), matrix=self.given_matrix))
        
    def test_tile_is_within_matrix_limits(self):
        self.assertTrue(tile_is_within_matrix_limits(tile=(0,0),matrix=self.basic_matrix))
        self.assertTrue(tile_is_within_matrix_limits(tile=(0,1),matrix=self.basic_matrix))
        self.assertTrue(tile_is_within_matrix_limits(tile=(1,0),matrix=self.basic_matrix))
        self.assertTrue(tile_is_within_matrix_limits(tile=(1,1),matrix=self.basic_matrix))

    def test_tile_is_not_within_matrix_limits(self):
        self.assertFalse(tile_is_within_matrix_limits(tile=(-1,0),matrix=self.basic_matrix))
        self.assertFalse(tile_is_within_matrix_limits(tile=(0,10),matrix=self.basic_matrix))
        self.assertFalse(tile_is_within_matrix_limits(tile=(100,100),matrix=self.basic_matrix))
        self.assertFalse(tile_is_within_matrix_limits(tile=(-1,-10),matrix=self.basic_matrix))
