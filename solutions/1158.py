...
assert list(sort_linked_list(Node.from_list(
    l))) == [-97, -59, -56, -22, -17, 0, 16, 19, 23, 31, 45, 53, 57, 62, 74, 76]
...
assert list(sort_linked_list(Node.from_list(l))
            ) == [-94, -78, -77, -57, -22, -20, 7, 24, 25, 29, 34, 49]

l = [30, 91, 40, -89, -17, -93, 67, 47, 100, 51, -61, -49]
assert list(sort_linked_list(Node.from_list(l))
            ) == [-93, -89, -61, -49, -17, 30, 40, 47, 51, 67, 91, 100]

l = [98, 91, -100, -13, -89, -30, -25, 97]
assert list(sort_linked_list(Node.from_list(l))
            ) == [-100, -89, -30, -25, -13, 91, 97, 98]

l = [-9, -48, 99, -5, 7, -91, -65, 7, -7, 66, -16, -54, 49, -18]
assert list(sort_linked_list(Node.from_list(l))
            ) == [-91, -65, -54, -48, -18, -16, -9, -7, -5, 7, 7, 49, 66, 99]

l = [-37, 52, 86, -26, 9, 41, 42, 42, -70]
assert list(sort_linked_list(Node.from_list(l))
            ) == [-70, -37, -26, 9, 41, 42, 42, 52, 86]

l = [67, -13, 23, 90, -95, -55, 4, 81, -36, 72, -1, 26, 11, -96, -40]
assert list(sort_linked_list(Node.from_list(l))
            ) == [-96, -95, -55, -40, -36, -13, -1, 4, 11, 23, 26, 67, 72, 81, 90]

l = [97, 14, -34, -1, -39, -74, 88, 95, -86]
assert list(sort_linked_list(Node.from_list(l))
            ) == [-86, -74, -39, -34, -1, 14, 88, 95, 97]

l = [-61, 54, -26, 34, 28, 90, -94]
assert list(sort_linked_list(Node.from_list(l))
            ) == [-94, -61, -26, 28, 34, 54, 90]

l = [79, -98, 2, -65, 62, 8, -19]
assert list(sort_linked_list(Node.from_list(l))
            ) == [-98, -65, -19, 2, 8, 62, 79]

l = [-14, -18, -18, 55, 36, -58, 56, 14, 43, -
     39, 4, 74, 47, -86, 7, 10, -3, 77, -56, 98]
assert list(sort_linked_list(Node.from_list(
    l))) == [-86, -58, -56, -39, -18, -18, -14, -3, 4, 7, 10, 14, 36, 43, 47, 55, 56, 74, 77, 98]

l = [-61, 2, -99, 69, -87, 24, 29, 34, -38, 93]
assert list(sort_linked_list(Node.from_list(l))
            ) == [-99, -87, -61, -38, 2, 24, 29, 34, 69, 93]
